...
\begin{document}
	...
	\section{Introduction}
		...
		Its key-feature are source-based packages, i.e. packages not based on pre-compiled binary tarballs but on recipes (called Ebuilds) on how to obtain, build and test the software, as well as a list of its dependencies.
